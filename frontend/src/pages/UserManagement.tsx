    ...
    <div style={{
      ...
      <div style={{
            ...
            <Col xs={24} sm={12}>
              <Space size={12} style={{ display: 'flex', justifyContent: isMobile ? 'flex-start' : 'flex-end', width: '100%' }}>
                <Button
                  ...
                  style={{
                    borderRadius: 12,
                    background: alphaColor(zhuqueColors.paperSoft, 0.14),
                    border: `1px solid ${alphaColor(zhuqueColors.paperSoft, 0.36)}`,
                    boxShadow: `0 8px 20px ${alphaColor(zhuqueColors.ink, 0.12)}`,
                    color: token.colorWhite,
                    transition: 'all 0.3s ease'
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = alphaColor(zhuqueColors.paperSoft, 0.22);
                    e.currentTarget.style.transform = 'translateY(-1px)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = alphaColor(zhuqueColors.paperSoft, 0.14);
                ...
                <Button
                  ...
                  style={{
                    borderRadius: 12,
                    background: `linear-gradient(135deg, ${zhuqueColors.cinnabar} 0%, ${zhuqueColors.cinnabarLight} 100%)`,
                    border: `1px solid ${alphaColor(zhuqueColors.gold, 0.34)}`,
                    boxShadow: `0 10px 22px ${alphaColor(zhuqueColors.cinnabar, 0.24)}`,
                    color: token.colorWhite,
                    fontWeight: 600
                  }}
                >
        ...
        <Card
          variant="borderless"
          style={{
            background: alphaColor(zhuqueColors.paperSoft, 0.9),
            borderRadius: isMobile ? 14 : 16,
