...
export default function Relationships() {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const [relationshipsData, relationshipTypesData, charactersData] = await Promise.all([
        api.get<unknown, Relationship[]>(`/relationships/project/${projectId}`),
  ...
  const handleUpdateRelationship = async (values: {
    ...
    try {
      await api.put(`/relationships/${editingRelationship.id}`, {
