...
import { DEFAULT_COMIC_STYLE } from '../constants/comicStyles';
  ...
  const renderChat = () => (
    <>
            ...
            >
              <div style={{
                ...
                background: msg.type === 'ai'
                  ? `linear-gradient(180deg, ${alphaColor(zhuqueColors.paperSoft, 0.95)} 0%, ${alphaColor(token.colorBgContainer, 0.88)} 100%)`
                  : `linear-gradient(135deg, ${zhuqueColors.cinnabar} 0%, ${zhuqueColors.cinnabarLight} 100%)`,
                color: msg.type === 'ai' ? token.colorText : token.colorWhite,
                boxShadow: msg.type === 'ai'
                  ? `0 8px 20px ${alphaColor(zhuqueColors.ink, 0.08)}`
                  : `0 10px 22px ${alphaColor(zhuqueColors.cinnabar, 0.18)}`,
              }}>
                <Paragraph
                  style={{
                    margin: 0,
      ...
      <Card
        style={{
          borderRadius: 14,
          border: `1px solid ${alphaColor(zhuqueColors.cinnabarDeep, 0.08)}`,
