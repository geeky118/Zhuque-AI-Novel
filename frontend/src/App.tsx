...
import ComicStyle from './pages/ComicStyle';
import PromptWorkshop from './pages/PromptWorkshop';
import ComicAdmin from './pages/ComicAdmin';
...
import { getAppBasename } from './utils/basePath';
import './App.css';
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/comic-admin" element={<ProtectedRoute><ComicAdmin /></ProtectedRoute>} />
        <Route path="/comic-admin/:projectId" element={<ProtectedRoute><ComicAdmin /></ProtectedRoute>} />
        <Route path="/project/:projectId" element={<ProtectedRoute><ProjectDetail /></ProtectedRoute>}>
          ...
          <Route path="comic-style" element={<ComicStyle />} />
