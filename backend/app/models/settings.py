...
class Settings(Base):
    ...
    # 图片生成配置
    cover_api_provider = Column(String(50), comment="图片API提供商")
    cover_api_key = Column(String(500), comment="图片API密钥")
    cover_api_base_url = Column(String(500), comment="图片自定义API地址")
    cover_image_model = Column(String(100), comment="图片模型名称")
    cover_enabled = Column(Boolean, default=False, server_default="0", nullable=False, comment="是否启用图片生成")
    image_text_language = Column(String(20), default="zh", server_default="zh", nullable=False, comment="图片内文字语言: zh/en")
    ...
    smtp_from_name = Column(String(255), default="朱雀AI小说", server_default="朱雀AI小说", nullable=False, comment="发件人名称")
