...
class ProjectBase(BaseModel):
    ...
    comic_style: Optional[str] = Field(default="guoman_refined", description="项目统一漫画风格")
    comic_style_prompt: Optional[str] = Field(None, description="自定义漫画风格提示词")
...
class ProjectUpdate(BaseModel):
    ...
    comic_style: Optional[str] = None
    comic_style_prompt: Optional[str] = None
...
class ProjectWizardRequest(BaseModel):
    ...
    comic_style: str = Field(default="guoman_refined", description="项目统一漫画风格")
    comic_style_prompt: Optional[str] = Field(None, description="自定义漫画风格提示词")
    target_words: Optional[int] = Field(None, description="目标字数")
    outline_mode: Literal["one-to-one", "one-to-many"] = Field(
        default="one-to-many",
