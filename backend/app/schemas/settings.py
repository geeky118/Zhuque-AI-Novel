...
class SettingsBase(BaseModel):
    ...
    cover_api_provider: Optional[str] = Field(default=None, description="图片API提供商")
    cover_api_key: Optional[str] = Field(default=None, description="图片API密钥")
    cover_api_base_url: Optional[str] = Field(default=None, description="图片自定义API地址")
    cover_image_model: Optional[str] = Field(default=None, description="图片模型名称")
    cover_enabled: Optional[bool] = Field(default=False, description="是否启用图片生成")
    image_text_language: Optional[str] = Field(default="zh", pattern="^(zh|en)$", description="图片内文字语言")
...
class SystemSMTPSettingsBase(BaseModel):
    ...
    smtp_from_name: str = Field(default="朱雀AI小说", description="发件人名称")
